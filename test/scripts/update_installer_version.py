...
# WIN INSTALLER
  ...
  for line in fileinput.input(projectpath + "/installer/" + BUNDLE_NAME + ".iss",inplace=1):
    ...
    if "OutputBaseFilename" in line:
      if demo:
        line="OutputBaseFilename=test Demo Installer\n"
      else:
        line="OutputBaseFilename=test Installer\n"
    ...
    if "WelcomeLabel1" in line:
     if demo:
       line="WelcomeLabel1=Welcome to the test Demo installer\n"
     else:
       line="WelcomeLabel1=Welcome to the test installer\n"
       
    if "SetupWindowTitle" in line:
     if demo:
       line="SetupWindowTitle=test Demo installer\n"
     else:
       line="SetupWindowTitle=test installer\n"
