...
def main():
  ...
  plistpath = scriptpath + "/resources/test-AU-Info.plist"
  ...
  plistpath = scriptpath + "/resources/test-VST3-Info.plist"
  ...
  plistpath = scriptpath + "/resources/test-OSXAPP-Info.plist"
  ...
  plistpath = scriptpath + "/resources/test-AAX-Info.plist"
  ...
  plistpath = scriptpath + "/installer/test.pkgproj"
  ...
  for line in fileinput.input(scriptpath + "/installer/test.iss",inplace=1):
