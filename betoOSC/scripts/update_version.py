...
def main():
  ...
  CFBundleGetInfoString = FullVersionStr + ", Copyright betov5, " + str(today.year)
  CFBundleVersion = FullVersionStr
  
  print "update_version.py - setting version to " + FullVersionStr
  print "Updating plist version info..."
  
  plistpath = scriptpath + "/resources/betoOSC-VST2-Info.plist"
  ...
  plistpath = scriptpath + "/resources/betoOSC-AU-Info.plist"
  ...
  plistpath = scriptpath + "/resources/betoOSC-VST3-Info.plist"
  ...
  plistpath = scriptpath + "/resources/betoOSC-OSXAPP-Info.plist"
  ...
  plistpath = scriptpath + "/resources/betoOSC-AAX-Info.plist"
  ...
  plistpath = scriptpath + "/installer/betoOSC.pkgproj"
  ...
  for line in fileinput.input(scriptpath + "/installer/betoOSC.iss",inplace=1):
