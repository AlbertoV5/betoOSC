...
# WIN INSTALLER
  ...
  for line in fileinput.input(projectpath + "/installer/" + BUNDLE_NAME + ".iss",inplace=1):
    ...
    if "OutputBaseFilename" in line:
      if demo:
        line="OutputBaseFilename=betoOSC Demo Installer\n"
      else:
        line="OutputBaseFilename=betoOSC Installer\n"
    ...
    if "WelcomeLabel1" in line:
     if demo:
       line="WelcomeLabel1=Welcome to the betoOSC Demo installer\n"
     else:
       line="WelcomeLabel1=Welcome to the betoOSC installer\n"
       
    if "SetupWindowTitle" in line:
     if demo:
       line="SetupWindowTitle=betoOSC Demo installer\n"
     else:
       line="SetupWindowTitle=betoOSC installer\n"
